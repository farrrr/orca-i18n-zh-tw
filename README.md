...
> **狀態：已對齊 Orca v1.4.210（137/137 批，涵蓋 14,281/14,283 條）、驗證通過（錯誤 0、警告 773 為棘輪化的規則債）** — v0.5.0 已發佈。
...
| 項目 | 數量 |
|---|---|
| 上游 `en.json` 字串總數（v1.4.210） | 14,497 |
...
CSS 與 CLI 指令翻譯後會失效或無法執行。發佈產物仍涵蓋 14,281 條。
