...
> **狀態：翻譯完整（106/106 批，涵蓋 11,614/11,616 條）、驗證通過（錯誤 0、警告 742 為棘輪化的規則債）** — 打包發佈中。
...
| **fail-closed 驗證** | 四道 CI gate 任一失敗即擋下發佈 |

## 涵蓋範圍

| 項目 | 數量 |
|---|---|
| 上游 `en.json` 字串總數 | 11,830 |
...
CSS 與 CLI 指令翻譯後會失效或無法執行。發佈產物仍涵蓋 11,616 條。
